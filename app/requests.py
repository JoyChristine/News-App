...
def get_top_headlines():
  ...
  get_headlines_url = 'https://newsapi.org/v2/top-headlines?country=us&apiKey=d56bc62864054634bf08615054f1cdb7'
...
def get_news_categories(category_name):
  ...
  function that gets the response to the category json
  '''
  get_cat_url = f'https://newsapi.org/v2/top-headlines?country=us&category={category_name}&apiKey=d56bc62864054634bf08615054f1cdb7'
...
def search_article(article_name):
  search_article_url = f'https://newsapi.org/v2/everything?q={article_name}&apiKey=d56bc62864054634bf08615054f1cdb7'.format(article_name, api_key)
...
# api_key = '0073535237c848a4b315104bc21e536e'
...
#   Function that gets the json response to our url request
#   '''
# #   get_news_url = .format(api_key)
#   get_news_source_url = 'https://newsapi.org/v2/sources?apiKey=0073535237c848a4b315104bc21e536e'
#   with urllib.request.urlopen(get_news_source_url) as url:
#     get_news_source_data = url.read()
#     get_news_source_response = json.loads(get_news_source_data)
...
#   function that gets the response to the category json
#   '''
#   get_category_url = f'https://newsapi.org/v2/top-headlines?country=ke&category={category_name}&apiKey=0073535237c848a4b315104bc21e536e'
...
# # ****************************************** SEARCH NEWS ******************************************************************************
# def search_article(article_name):
#   search_article_url = f'https://newsapi.org/v2/everything?q={article_name}&apiKey=0073535237c848a4b315104bc21e536e'.format(article_name, api_key)
#   with urllib.request.urlopen(search_article_url) as url:
#     search_article_data = url.read()
#     search_article_response = json.loads(search_article_data)
...
#       article_objects = News_articles(author, title, description, url, image, publishedAt)
#       article_source_results.append(article_objects)
